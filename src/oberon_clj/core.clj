...
(def test-oberon-syntax
  "Tests oberon parser, causes Class exception in the case of failure as https://www.zotero.org/instaparse failure object cannot be casted into Clojure IFn(I think)"
  (instaparse/parse oberon-parser oberon-test-code))

(def diff-syntax-tree
